...
class NodeRenderer {
  ...
  drawNodeShape(ctx, x, y, width, height, scale, nodeStyle, opacity = 1.0, node = null) {
    ...
    const isDarkMode = document.documentElement.getAttribute('data-theme') === 'dark';
    const nodeData = {"start_pipeline": {"type": "start", "class_name": "HarborValeFlow"}, "load_dataset": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["start_pipeline"]}, "run_analyst_crew": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["load_dataset"]}, "inject_fault_if_requested": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["run_analyst_crew"]}, "validate_handoff": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["inject_fault_if_requested"]}, "gate_router": {"type": "router", "class_name": "HarborValeFlow", "is_router": true, "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["validate_handoff"]}, "halt_pipeline": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["gate_failed"]}, "run_scientist_crew": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["gate_passed"]}, "verify_crew2_outputs": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["run_scientist_crew"]}, "finalize_success": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["verify_crew2_outputs"]}, "finalize_validate_only": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["validation_only_complete"]}, "write_run_summary": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["halt_pipeline", "finalize_success", "finalize_validate_only"], "trigger_condition": {"type": "OR", "conditions": ["halt_pipeline", "finalize_success", "finalize_validate_only"]}}};
    ...
    if (metadata.router_events && metadata.router_events.length > 0) {
      ...
      metadataContent += `
                <div class="drawer-section">
                    ...
                    <ul class="drawer-list">
                        ${uniqueRouterEvents.map((eventName) => `<li><span class="drawer-code-link" data-router-event="${eventName}" style="color: #FF5A50; border-color: rgba(255,90,80,0.3);">${eventName}</span></li>`).join("")}
                    </ul>
                </div>
            `;
    }
...
class NetworkManager {
  ...
  async initialize() {
    try {
      ...
      this.nodes = new vis.DataSet([{"id": "start_pipeline", "label": "start_pipeline", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">start_pipeline</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">start</span>\n            </div>\n        ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "start_pipeline", "bgColor": "var(--node-bg-start)", "borderColor": "var(--node-border-start)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "load_dataset", "label": "load_dataset", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">load_dataset</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">start_pipeline</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 1, "nodeStyle": {"name": "load_dataset", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "run_analyst_crew", "label": "run_analyst_crew", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">run_analyst_crew</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">load_dataset</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 2, "nodeStyle": {"name": "run_analyst_crew", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "inject_fault_if_requested", "label": "inject_fault_if_requested", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">inject_fault_if_requested</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">run_analyst_crew</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 3, "nodeStyle": {"name": "inject_fault_if_requested", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "validate_handoff", "label": "validate_handoff", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">validate_handoff</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">inject_fault_if_requested</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 4, "nodeStyle": {"name": "validate_handoff", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "gate_router", "label": "gate_router", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">gate_router</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">router</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">validate_handoff</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 5, "nodeStyle": {"name": "gate_router", "bgColor": "var(--node-bg-router)", "borderColor": "#FF5A50", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "halt_pipeline", "label": "halt_pipeline", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">halt_pipeline</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">gate_failed</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "halt_pipeline", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "run_scientist_crew", "label": "run_scientist_crew", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">run_scientist_crew</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">gate_passed</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "run_scientist_crew", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "verify_crew2_outputs", "label": "verify_crew2_outputs", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">verify_crew2_outputs</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">run_scientist_crew</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "verify_crew2_outputs", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "finalize_success", "label": "finalize_success", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">finalize_success</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">verify_crew2_outputs</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "finalize_success", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "finalize_validate_only", "label": "finalize_validate_only", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">finalize_validate_only</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">validation_only_complete</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "finalize_validate_only", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "write_run_summary", "label": "write_run_summary", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">write_run_summary</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">halt_pipeline</code></li><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">finalize_success</code></li><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">finalize_validate_only</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "write_run_summary", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}]);
      this.edges = new vis.DataSet([{"from": "start_pipeline", "to": "load_dataset", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "load_dataset", "to": "run_analyst_crew", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "run_analyst_crew", "to": "inject_fault_if_requested", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "inject_fault_if_requested", "to": "validate_handoff", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "validate_handoff", "to": "gate_router", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "run_scientist_crew", "to": "verify_crew2_outputs", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "verify_crew2_outputs", "to": "finalize_success", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "halt_pipeline", "to": "write_run_summary", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "finalize_success", "to": "write_run_summary", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "finalize_validate_only", "to": "write_run_summary", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}]);
  ...
  setupExportControls() {
    ...
    //   const dagData = {"nodes": {"start_pipeline": {"type": "start", "class_name": "HarborValeFlow"}, "load_dataset": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["start_pipeline"]}, "run_analyst_crew": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["load_dataset"]}, "inject_fault_if_requested": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["run_analyst_crew"]}, "validate_handoff": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["inject_fault_if_requested"]}, "gate_router": {"type": "router", "class_name": "HarborValeFlow", "is_router": true, "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["validate_handoff"]}, "halt_pipeline": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["gate_failed"]}, "run_scientist_crew": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["gate_passed"]}, "verify_crew2_outputs": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["run_scientist_crew"]}, "finalize_success": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["verify_crew2_outputs"]}, "finalize_validate_only": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["validation_only_complete"]}, "write_run_summary": {"type": "listen", "class_name": "HarborValeFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["halt_pipeline", "finalize_success", "finalize_validate_only"], "trigger_condition": {"type": "OR", "conditions": ["halt_pipeline", "finalize_success", "finalize_validate_only"]}}}, "edges": [{"source": "start_pipeline", "target": "load_dataset", "condition_type": "OR", "is_router_event": false}, {"source": "load_dataset", "target": "run_analyst_crew", "condition_type": "OR", "is_router_event": false}, {"source": "run_analyst_crew", "target": "inject_fault_if_requested", "condition_type": "OR", "is_router_event": false}, {"source": "inject_fault_if_requested", "target": "validate_handoff", "condition_type": "OR", "is_router_event": false}, {"source": "validate_handoff", "target": "gate_router", "condition_type": "OR", "is_router_event": false}, {"source": "run_scientist_crew", "target": "verify_crew2_outputs", "condition_type": "OR", "is_router_event": false}, {"source": "verify_crew2_outputs", "target": "finalize_success", "condition_type": "OR", "is_router_event": false}, {"source": "halt_pipeline", "target": "write_run_summary", "condition_type": "OR", "is_router_event": false}, {"source": "finalize_success", "target": "write_run_summary", "condition_type": "OR", "is_router_event": false}, {"source": "finalize_validate_only", "target": "write_run_summary", "condition_type": "OR", "is_router_event": false}], "start_methods": ["start_pipeline"], "router_methods": ["gate_router"]};
